package com.itservz.android.pokerstimate.sensor;
...
public class ShakeDetector implements SensorEventListener {
    ...
    private static ShakeDetector INSTANCE = new ShakeDetector();
    private ShakeDetector(){}
    public static ShakeDetector getInstance(){return INSTANCE;}
